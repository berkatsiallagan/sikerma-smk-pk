...
--
-- Host: localhost
-- Waktu pembuatan: 20 Jun 2025 pada 10.20
...
--
ALTER TABLE `ajuan`
  MODIFY `id_ajuan` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `mitra`
  MODIFY `id_mitra` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
