...
<form class="space-y-4">
    ...
    <div class="flex items-center gap-4">
      <label class="w-40 font-bold text-sm">Nama Jurusan</label>
      <input type="text" placeholder="Masukkan nama jurusan" class="flex-1 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-600" />
    </div>

  </form>

  <div class="flex justify-end mt-4">
  <a href="/" class="px-6 py-2 bg-amber-600 text-white font-bold rounded-lg hover:bg-amber-700 transition inline-flex items-center">
